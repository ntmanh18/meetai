...
const statusColorMap = {
  ...
  proccessing: "bg-rose-500/200 text-rose-800 border-rose-800/5",
  cancelled: "bg-gray-500/200 text-gray-800 border-gray-800/5"
}
...
export const columns: ColumnDef<Meeting>[] = [
  {
    ...
    header: "Meeting Name",
    cell: ({row}) => (
        <div className="flex-1 flex-col  gap-y-1 p-1.5">
  ...
  },
  {
    ...
    cell: ({row}) => {
      ...
      return (
        <Badge 
        variant="outline"
        className={cn("capitalize [&svvg]:size-4 text-muted-foreground", statusColorMap[row.original.status as keyof typeof statusColorMap])}>
          <Icon
